"""
Step 2: 멀티프레임 데이터 증강 + 듀얼뷰 + Pseudo-Label 학습

영상 초반 프레임(1~5)을 추가 학습 이미지로 활용.
라벨은 hard label 유지 (soft label 실패했으므로).
학습 데이터: train 1000x6 + dev 100 + pseudo 847 = ~6947
"""
import os
import torch
...
EXTRA_FRAMES = [1, 2, 3, 4, 5]  # 사용할 추가 프레임 번호
