...
from train import StructureDataset, ConvNeXtClassifier, DATA_ROOT, IMG_SIZE, MODEL_NAME
...
def main():
    ...
    sub_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "submissions")
    os.makedirs(sub_dir, exist_ok=True)
    save_path = os.path.join(sub_dir, "submission_exp003.csv")
